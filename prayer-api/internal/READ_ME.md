...
| PATCH `/api/prayer-groups/{groupID}` | Implemented |
| DELETE `/api/prayer-groups/{groupID}` | Implemented |
| POST `/api/users/{userID}/prayer-groups/{groupID}` | Implemented |
| DELETE `/api/users/{userID}/prayer-groups/{groupID}` | Implemented |
